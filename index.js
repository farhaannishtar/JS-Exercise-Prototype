...
*/
function Baby(name, price, favoriteToy) {
  Person.call(this, name, price, favoriteToy);
...
const arlo = new Baby({name: 'Arlo', age: 1, stomach:[], favoriteToy: 'cucumber'});
console.log(arlo.play());
console.log(arlo);
